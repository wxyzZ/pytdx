...
class SetupCmd1(BaseParser):
    def setup(self):
        ...
        self.send_pkg = bytearray.fromhex(u'0c 00 00 00 00 00 02 00 02 00 15 00')
...
class SetupCmd2(BaseParser):
    def setup(self):
        ...
        self.send_pkg = bytearray.fromhex(u'0c0218940001030003000d0001')
...
class SetupCmd3(BaseParser):
    ...
    def setup(self):
        ...
        #                               u'00 00 02')
        self.send_pkg = bytearray.fromhex(u'0c031899000120002000db0fb9fabdf0d6a4c8af000000f628f440000000000000000000000000000004')
    def parseResponse(self, body_buf):
        return body_buf